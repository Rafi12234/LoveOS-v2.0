...
export const TERMINAL_COMMANDS = {
  ...
  'next dev --turbo': {
    output: [
      '> next dev --turbo',
      '',
      '▲ Love Preview Mode (Turbo)',
      '- Local:   http://our-love.local:3000',
      '- Network: http://our-story.local:3000',
      '',
      'ready - love preview started at http://localhost:3000',
      'event - home refreshed with your smile in 198ms',
      'event - memory-vault refreshed in 121ms',
      'event - anniversary page refreshed in 109ms',
      '',
      '[ok] Every update appears instantly, just like my feelings.',
    ],
  },
  'next route:list': {
    output: [
      ...
      '/anniversary      -> our special day',
      '/memory-vault     -> all our precious moments',
      '/terminal         -> the place I talk to you in code',
      '/api/love/status  -> heartbeat and feelings status',
      '',
      'Protection',
      '  Every route guarded by care and respect',
      '',
      'Shortcut',
      '  /us -> /anniversary',
      '',
      '[ok] Journey map generated successfully.',
    ],
  },
  status: {
