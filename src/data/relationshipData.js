...
export const TERMINAL_COMMANDS = {
  ...
  'g++ compile-love.cpp': {
    output: [
      ...
      '',
      'Turning my feelings into a forever message...',
      '',
      'Love letter draft: ready',
      'Sweet promises: attached',
      'Warm memories: linked together',
      '',
      '[ok] Your forever message is ready.',
      `     Made specially for: ${HER_NAME}`,
      '     Status: endless love',
    ],
  },
  'javac heart.java': {
    output: [
      '> javac Heart.java PromiseManager.java ForeverService.java',
      '',
      'Preparing heart promises...',
      '  Heart.java -> your place in my heart',
      '  PromiseManager.java -> promises I keep',
      '  ForeverService.java -> love without end',
      '',
      'No confusing feelings found.',
      'Everything is clear, honest, and from the heart.',
      '',
      '[ok] Promises prepared successfully.',
