...
export const TERMINAL_COMMANDS = {
  ...
  'java heart': {
    output: [
      ...
      '',
      'Starting our forever story...',
      'Loading trust, care, laughter, and loyalty',
      `Center of everything: ${HER_NAME}`,
      '',
      'HeartRuntime.start();',
      'while (true) {',
      '  love.deepen();',
      '  memories.append(new BeautifulMoment());',
      '}',
      '',
      '[ok] Story is running.',
      '     Mood: very happy',
      '     Sad moments: healed with love',
    ],
  },
  'npx next build': {
    output: [
      ...
      '',
      '▲ Next.js 15.0.0-love',
      '- Environments: .env.forever',
      '',
      'Packing our memories into a beautiful gift...',
      '✓ Story assembled successfully in 1.4s',
      '✓ Gathering moments and milestones',
      '✓ Creating pages full of us (14/14)',
      '✓ Final touch added with love',
      '',
      'Route (app)                         Size     First Load JS',
      '/                                  12.3 kB  95.6 kB',
      '/memory-vault                        9.8 kB  90.1 kB',
      '/anniversary                         6.1 kB  87.4 kB',
      '',
